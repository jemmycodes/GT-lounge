  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <main className="bg-bgBlack h-[90vh]  flex justify-between flex-col gap-5 rounded-t-3xl p-6 pb-1">
        <section className="flex flex-col gap-6 h-[80%] overflow-y-auto scrollbar-hide">
          <hgroup className="bg-lang-card-color justify-between flex items-center text-gold p-4 gap-2 rounded-xl">
            <div className="flex gap-2 items-center">
              ...
              <span className="flex gap-2 flex-col">
                <h3 className="font-semibold whitespace-pre-wrap">Ice Cream</h3>
